"""
integration tests for the `textfsmgen.tools.translator.IterateSuggester` class.

Usage
-----
Run pytest in the project root to execute these tests:
    $ pytest tests/integration/tools/test_iterate_translator.py
    or
    $ python -m pytest tests/integration/tools/test_iterate_translator.py
"""
