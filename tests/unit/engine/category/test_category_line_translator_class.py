...
class TestCategoryLineTranslator:
    ...
    def test_to_regex(self, line: str, count: int, expected_pattern: str,
        ...
        count : int
            Count argument passed to `CategoryLineTranslator`.
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                3,
                r'fruits: letters(var_fruits)  meat:optional_spaces()anything(var_meat, or_empty)  drinks: letters(var_drinks)',    # noqa
                dedent_and_strip(r"""
                    ################################################################################
                    # Template is generated by TextFSMGen CE
                    # Created date: YYYY-mm-dd
            ...
            (
                ...
                3,
                r'fruits:optional_spaces()anything(var_fruits, or_empty)  meat:optional_spaces()anything(var_meat, or_empty)  drinks: letters(var_drinks)',     # noqa
                dedent_and_strip(r"""
                    ################################################################################
                    # Template is generated by TextFSMGen CE
                    # Created date: YYYY-mm-dd
