"""
Unit tests for the `textfsmgen.engine.iterative` module.

Usage
-----
Run pytest in the project root to execute these tests:
    $ pytest tests/unit/engine/iterative/test_iterative_lines_translator_class.py
    or
    $ python -m pytest tests/unit/engine/iterative/test_iterative_lines_translator_class.py
"""
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                r'blab blab blab(\r?\n|\r)fruits: (?P<v11>[\x21-\x7e]*[a-zA-Z0-9][\x21-\x7e]*(\s+[\x21-\x7e]*[a-zA-Z0-9][\x21-\x7e]*)*)(\r?\n|\r)meat: (?P<v21>[\x21-\x7e]*[a-zA-Z0-9][\x21-\x7e]*(\s+[\x21-\x7e]*[a-zA-Z0-9][\x21-\x7e]*)*)(\r?\n|\r)blab \*\+{2,} \?\?\?blab\*\?\+'     # noqa
            ),
        ]
    )
        ...
        [
            (
                ...
                dedent(r"""
                    ...
                    ################################################################################
                    Value v11 ([\x21-\x7e]*[a-zA-Z0-9][\x21-\x7e]*(\s+[\x21-\x7e]*[a-zA-Z0-9][\x21-\x7e]*)*)
                    Value v21 ([\x21-\x7e]*[a-zA-Z0-9][\x21-\x7e]*(\s+[\x21-\x7e]*[a-zA-Z0-9][\x21-\x7e]*)*)
