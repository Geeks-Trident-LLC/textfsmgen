"""
Unit tests for the `textfsmgen.engine.translate.WordTranslator` class.

Usage
-----
Run pytest in the project root to execute these tests:
    $ pytest tests/unit/translate/test_word_translator_class.py
    or
    $ python -m pytest tests/unit/translate/test_word_translator_class.py
"""
