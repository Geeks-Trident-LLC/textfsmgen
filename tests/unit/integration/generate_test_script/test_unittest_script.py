"""
Integration tests for the `textfsmgen.core.TemplateBuilder.create_unittest` method.

Usage
-----
Run pytest in the project root to execute these tests:
    $ pytest tests/integration/generate_test_script/test_unittest_script.py
    or
    $ python -m pytest tests/integration/generate_test_script/test_unittest_script.py
"""
