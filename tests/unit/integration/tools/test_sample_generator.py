"""
integration tests for the `textfsmgen.tools.samples.SamplesGenerator` class.

Usage
-----
Run pytest in the project root to execute these tests:
    $ pytest tests/integration/tools/test_sample_generator.py
    or
    $ python -m pytest tests/integration/tools/test_sample_generator.py
"""
