"""
integration tests for the `textfsmgen.tools.token.WhitespaceSnippet` class.

Usage
-----
Run pytest in the project root to execute these tests:
    $ pytest tests/integration/tools/test_whitespace_snippet.py
    or
    $ python -m pytest tests/integration/tools/test_whitespace_snippet.py
"""
