...
Run pytest in the project root to execute these tests:
    $ pytest tests/integration/category_form/test_line_to_template.py
    or
    $ python -m pytest tests/integration/category_form/test_line_to_template.py
"""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "fruits:   meat: ",
            2,
            r"fruits:optional_spaces()anything(var_fruits)  meat:optional_spaces()anything(var_meat)",  # noqa
            dedent_and_strip(r"""
                ################################################################################
                # Template is generated by TextFSMGen CE
                # Created date: YYYY-mm-dd
        ...
        (
            ...
            3,
            r"fruits: word(var_fruits)  meat:optional_spaces()anything(var_meat)  drinks: word(var_drinks)",  # noqa
            dedent_and_strip(r"""
                ################################################################################
                # Template is generated by TextFSMGen CE
                # Created date: YYYY-mm-dd
        ...
        (
            ...
            3,
            r"fruits:optional_spaces()anything(var_fruits)  meat:optional_spaces()anything(var_meat)  drinks: word(var_drinks)",  # noqa
            dedent_and_strip(r"""
                ################################################################################
                # Template is generated by TextFSMGen CE
                # Created date: YYYY-mm-dd
