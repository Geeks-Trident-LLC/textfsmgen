...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("optional_non_whitespace_group()",         f"({non_whitespaces}({sep}{non_whitespaces})+)?"),
        ("optional_non_whitespaces_group()",        f"({non_whitespaces}({sep}{non_whitespaces})+)?"),
        ...
        ("optional_non_whitespace_items()",         f"({non_whitespaces}({sep}{non_whitespaces})*)?"),
        ("optional_non_whitespaces_items()",        f"({non_whitespaces}({sep}{non_whitespaces})*)?"),
    ]
)
