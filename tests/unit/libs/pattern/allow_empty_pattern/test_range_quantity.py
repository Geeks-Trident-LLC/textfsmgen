...
@pytest.mark.parametrize(
    ...
    [  # name                          pattern                                         expected
        ...
        (
            "2_to_4_mixed_word",
            rf"{mixed_word}({sep}{mixed_word}){{1,3}}",
            rf"({mixed_word}({sep}{mixed_word}){{1,3}})?",
        ),
        (
            "two_to_four_mixed_word",
            rf"{mixed_word}({sep}{mixed_word}){{1,3}}",
            rf"({mixed_word}({sep}{mixed_word}){{1,3}})?",
        ),
        (
            "2_to_4_number",
            rf"{number}({sep}{number}){{1,3}}",
            rf"({number}({sep}{number}){{1,3}})?",
        ),
        (
            "two_to_four_number",
        ...
        (
            "2_to_4_mixed_number",
            rf"{mixed_number}({sep}{mixed_number}){{1,3}}",
            rf"({mixed_number}({sep}{mixed_number}){{1,3}})?",
        ),
        (
            "two_to_four_mixed_number",
            rf"{mixed_number}({sep}{mixed_number}){{1,3}}",
            rf"({mixed_number}({sep}{mixed_number}){{1,3}})?",
        ),
    ],
