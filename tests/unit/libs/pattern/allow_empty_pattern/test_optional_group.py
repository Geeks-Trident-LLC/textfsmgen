...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "optional_numbers_group",
            rf"({number}({sep}{number})+)?",
            rf"({number}({sep}{number})+)?",
        ),
        (
            "optional_mixed_numbers_group",
            rf"({mixed_number}({sep}{mixed_number})+)?",
            rf"({mixed_number}({sep}{mixed_number})+)?",
        ),
        # --- letters ---
        ...
        # space or punct
        (
            "optional_space_or_punct_group",
            rf"({spaces_or_puncts}({sep}{spaces_or_puncts})+)?",
            rf"({spaces_or_puncts}({sep}{spaces_or_puncts})+)?",
        ),
        # letter or punct
        (
            "optional_letter_or_punct_group",
            rf"({letters_or_puncts}({sep}{letters_or_puncts})+)?",
            rf"({letters_or_puncts}({sep}{letters_or_puncts})+)?",
        ),
        # --- word ---
        (
