...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("mixed_number",        rf"{mixed_number}",         rf"({mixed_number})?",),
        ("numbers",             rf"{number}({sep}{number})*",               rf"({number}({sep}{number})*)?"),
        ("mixed_numbers",       rf"{mixed_number}({sep}{mixed_number})*",   rf"({mixed_number}({sep}{mixed_number})*)?"),
        ...
        ("mixed_words",         rf"{mixed_word}({sep}{mixed_word})*",   rf"({mixed_word}({sep}{mixed_word})*)?"),
