...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("some_mixed_number",        rf"{mixed_number}({sep}{mixed_number})*",   rf"({mixed_number}({sep}{mixed_number})*)?"),
        ("some_numbers",             rf"{number}({sep}{number})*",               rf"({number}({sep}{number})*)?"),
        ("some_mixed_numbers",       rf"{mixed_number}({sep}{mixed_number})*",   rf"({mixed_number}({sep}{mixed_number})*)?"),
        ...
        # --- mixed-word
        ("some_mixed_word",          rf"{mixed_word}({sep}{mixed_word})*",   rf"({mixed_word}({sep}{mixed_word})*)?"),
        ("some_mixed_words",         rf"{mixed_word}({sep}{mixed_word})*",   rf"({mixed_word}({sep}{mixed_word})*)?"),
