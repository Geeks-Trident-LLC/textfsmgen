...
@pytest.mark.parametrize(
    ...
    [
        ...
        # allow empty
        ((" ", "", "   "), {"var_name": "v0", "generic": False}, True, "spaces(var_v0, or_empty)"),
        ((" \t ", "", "  "), {"var_name": "v1", "generic": False}, True, "wss(var_v1, or_empty)"),

        # generic=True behaves the same
        ((" ", "", "   "), {"var_name": "v0", "generic": True}, True, "spaces(var_v0, or_empty)"),
        ((" \t ", "", "  "), {"var_name": "v1", "generic": True}, True, "wss(var_v1, or_empty)"),
